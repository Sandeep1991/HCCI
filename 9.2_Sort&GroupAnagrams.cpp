//9.2 Sort an array of strings so that all anagrams are next to each other
/* Algorithm
1. Create 2 aux arrays index and words
2. Sort individual words in words[]
3. Sort the words array
4. Use index array to print the original words
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
